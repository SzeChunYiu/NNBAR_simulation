...
def test_blank_feature_column_names_fail_closed_as_invalid_contracts():
    audit = audit_rfc_feature_provenance(feature_columns=("total_energy", "   "))
...
def test_duplicate_feature_column_names_fail_closed_as_invalid_contracts():
    audit = audit_rfc_feature_provenance(
        feature_columns=("total_energy", "total_energy")
    )
