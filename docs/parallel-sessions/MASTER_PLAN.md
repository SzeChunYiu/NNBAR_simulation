...
| **Geant4 fork bootstrap (upstream MR workflow)** | NEXT | g4-fork-bootstrap | See `docs/parallel-sessions/g4-fork-bootstrap.md`; clone gitlab.cern.ch/geant4/geant4 v11.2.2, set up upstream contribution pipeline so CPU optimizations benefit every Geant4 user, not just NNBAR |
