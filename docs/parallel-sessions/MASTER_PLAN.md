...
| TPC W-value policy audit | DONE | tpc-w-value-policy-audit | See `docs/parallel-sessions/tpc-w-value-policy-audit.md`; expose production 23.6 eV versus 26.0--27.4 eV reference scaling as tested Python policy without editing over-cap calibration or C++ source files. |
