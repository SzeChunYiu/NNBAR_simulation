...
| Timing-window acceptance and filtered-energy regression | RUNNING | timing-window-regression | See `docs/parallel-sessions/timing-window-regression.md`; worker-1 is adding boundary/filtered-energy regressions for Ch.7 timing windows and Ch.9 cutflow observables. |
