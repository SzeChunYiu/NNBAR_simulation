...
| GEANT4 physics-list reproducibility audit | RUNNING | geant4-physics-list-audit | See `docs/parallel-sessions/geant4-physics-list-audit.md`; document observed physics constructors, Geant4 version evidence, and FTFP_BERT versus FTFP_BERT_HP validation tags without running new simulations. |
...
| TPC W-value policy audit | RUNNING | tpc-w-value-policy-audit | See `docs/parallel-sessions/tpc-w-value-policy-audit.md`; expose production 23.6 eV versus 26.0--27.4 eV reference scaling as tested Python policy without editing over-cap calibration or C++ source files. |
