...
| **CRY SLURM array (27/27 nonzero jobs submitted)** | RUNNING | cosmic-slurm-array | 27-bin matrix patch committed in nested `NNBAR_Detector` on `main` and `lane/cosmic-slurm-array` as `a344a47` (`fix(slurm): cover gamma cosmic bin 4`). Jobs 3040180/3040259 account for the original 26-job matrix (3040180_0-11 failed and are retried by 3040259; 3040180_12-23 and 3040259_0,1,2,3,6,7,8,10,11 completed). Gamma bin4 recovery (`particleIdx=1`, `energyBin=4`, 10-50 GeV, `N=2.30e7`) is job 3040275_10. 2026-05-11 11:57 CEST guarded LUNARC check (`ssh -O check` then `squeue -j 3040180,3040259,3040275 --array` and `sacct -X`) still showed six RUNNING blockers: 3040180_24,25; 3040259_4,5,9; 3040275_10. Elapsed times: 3040180_24/25 9:43:57, 3040259_4/5/9 3:26:22, 3040275_10 3:15:01. Fresh log tails reached 3040180_24~924,974, 3040259_4~656,602, 3040259_9~538,089, 3040275_10~114,826; high-energy 3040180_25 and 3040259_5 remained RUNNING with stale/slow stdout (`cosmic-3040180_25.out` mtime 02:20 CEST, visible event 2553; `cosmic-3040259_5.out` mtime 08:34 CEST, visible event 357). Keep open until these finish, fail, or cancel; do not duplicate gamma bin4 while 3040275_10 is RUNNING. |
...
| Worker-0 lane-doc RTK/LUNARC command guard | RUNNING | worker-0-doc-guard | Follow-up from planner review of `cac8de4`; fix raw shell examples and add the LUNARC socket-init guard in `docs/parallel-sessions/worker-0.md`. |
...
| Vertex smearing-closure toy validation | NEXT | vertex-smearing-closure | See `docs/parallel-sessions/vertex-smearing-closure.md`; add a seeded synthetic closure test for the explicit \(\sigma(\theta)\) projected-position weighting contract without inventing Ch.7 plot values. |
| Timing-window acceptance and filtered-energy regression | NEXT | timing-window-regression | See `docs/parallel-sessions/timing-window-regression.md`; add boundary/filtered-energy regressions for Ch.7 timing windows and Ch.9 cutflow observables. |
