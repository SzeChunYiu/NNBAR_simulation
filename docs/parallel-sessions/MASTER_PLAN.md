...
| **G4GPU isolation audit** | RUNNING | g4gpu-isolation-audit | See `docs/parallel-sessions/g4gpu-isolation-audit.md`; verify no current cross-contamination and lock in clean baseline |
