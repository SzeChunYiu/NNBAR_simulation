...
| **CRY SLURM array (27/27 nonzero jobs submitted)** | RUNNING | cosmic-slurm-array | 27-bin matrix patch committed in nested `NNBAR_Detector` on `main` and `lane/cosmic-slurm-array` as `a344a47` (`fix(slurm): cover gamma cosmic bin 4`). Jobs 3040180/3040259 account for the original 26-job matrix; gamma bin4 recovery (`particleIdx=1`, `energyBin=4`, 10-50 GeV, `N=2.30e7`) is job 3040275_10. 2026-05-11 13:02 CEST guarded LUNARC check (`ssh -O check`, then `squeue -j 3040180,3040259,3040275 --array`, `sacct -X`, and stdout tails) still showed five RUNNING external blockers: 3040180_25, 3040259_4, 3040259_5, 3040259_9, and 3040275_10. Elapsed/time-left: 3040180_25 10:48:14/1:11:46; 3040259_4/5/9 04:30:39/7:29:21; 3040275_10 04:19:18/7:40:42. Fresh stdout tails reached 3040259_4 event ~866,210, 3040259_9 event ~703,760, and 3040275_10 event ~154,223; high-energy 3040180_25 and 3040259_5 remained RUNNING with stale/slow stdout (`slurm/cosmic-3040180_25.out` mtime 02:20 CEST, visible event 2553; `slurm/cosmic-3040259_5.out` mtime 08:34 CEST, visible event 357). Keep open until these finish, fail, or cancel; do not duplicate gamma bin4 while 3040275_10 is RUNNING. |
...
| HIBEAM TPC GNN feature-contract and final-result closure | RUNNING | hibeam-gnn-feature-contract | See `docs/parallel-sessions/hibeam-gnn-feature-contract.md`; audit TrackGNN/VertexGNN feature schema, Compton levels, split evidence, `sigma_r`, `epsilon`, uncertainties, and deployable/oracle labels before thesis or paper numbers are promoted. |
