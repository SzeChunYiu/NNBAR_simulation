...
| TPC response and digitization boundary audit | RUNNING | tpc-response-boundary-audit | See `docs/parallel-sessions/tpc-response-boundary-audit.md`; make thesis first-order TPC electron-count response and advanced/non-thesis digitization boundaries explicit and tested before reconstruction claims mix evidence levels. |
