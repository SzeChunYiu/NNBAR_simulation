...
| Charged-object cone energy and beampipe deflection validation | NEXT | charged-cone-deflection | See `docs/parallel-sessions/charged-cone-deflection.md`; fail-closed audit for Ch. 7 25° cone and beampipe deflection provenance. |
