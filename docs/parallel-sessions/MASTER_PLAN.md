...
| **Supervisor 6-pane protocol refresh** | RUNNING | supervisor-protocol-refresh | Claimed by worker-2 on 2026-05-11 to reconcile shared protocol, planner queue instructions, and isolation policy with the active worker-0..4 + planner batch. |
