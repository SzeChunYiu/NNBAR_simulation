...
| **CRY SLURM array (27/27 nonzero jobs submitted)** | RUNNING | cosmic-slurm-array | 27-bin matrix patch committed in nested `NNBAR_Detector` on `main` and `lane/cosmic-slurm-array` as `a344a47` (`fix(slurm): cover gamma cosmic bin 4`). Jobs 3040180/3040259 account for the original 26-job matrix; gamma bin4 recovery (`particleIdx=1`, `energyBin=4`, 10-50 GeV, `N=2.30e7`) is job 3040275_10. 2026-05-11 13:27 CEST guarded LUNARC check (`ssh -O check`, then `squeue -j 3040180,3040259,3040275 --array`, `sacct -X`, and stdout tails) still showed five RUNNING external blockers: 3040180_25, 3040259_4, 3040259_5, 3040259_9, and 3040275_10. Elapsed/time-left from `squeue`: 3040180_25 11:13:38/0:46:22; 3040259_4/5/9 04:56:03/7:03:57; 3040275_10 04:44:42/7:15:18. Fresh stdout tails reached 3040259_4 event ~945,673, 3040259_9 event ~770,132, and 3040275_10 event ~168,612; high-energy 3040180_25 and 3040259_5 remained RUNNING with stale/slow stdout (`slurm/cosmic-3040180_25.out` mtime 02:20 CEST, visible event 2553; `slurm/cosmic-3040259_5.out` mtime 08:34 CEST, visible event 357). Keep open until these finish, fail, or cancel; do not duplicate gamma bin4 while 3040275_10 is RUNNING. |
...
| HIBEAM vertex method-comparison and metric-table closure | RUNNING | hibeam-vertex-method-closure | See `docs/parallel-sessions/hibeam-vertex-method-closure.md`; audit Least-squares, Trackless, GraphNeT, and Clustering+GNN metrics across Compton levels with verified datasets, splits, uncertainties, and deployable/oracle status. |
