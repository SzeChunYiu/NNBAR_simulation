...
| HIBEAM GNN test path portability fix | NEXT | fix-hibeam-gnn-paths | Review finding from `bd01ba9`: `tests/test_hibeam_gnn_feature_contract.py` hard-codes `/Volumes/MyDrive/nnbar/papers/overleaf-696757e2/main.tex`; replace with environment/fixture/skip-safe path handling and keep focused/full pytest green. |
