...
Current handoff (2026-05-11 10:39 CEST): the 27-bin matrix patch was
...
and `sacct` show the same seven remaining RUNNING blockers. Latest
trailing-log event maxima are: `3040180_24` proton bin4 (~806k events),
`3040180_25` proton bin5 (~3.1k; slow), `3040259_4` mu- bin4 (~409k),
`3040259_5` mu- bin5 (~3.3k; slow), `3040259_8` gamma bin2 (~827k),
`3040259_9` gamma bin3 (~337k), and `3040275_10` gamma bin4 (~70k).
