...
depends_on: [00_README, 50_reviewer_defense_package, 51_reviewer_question_registry, 52_run_orchestration, 53_ci_regression_suite, 54_open_data_archival, 55_internal_note_template, 55_internal_note_template_l1_annex_fixture]
outputs:
...
| **plan-33 promotion companion** | Split plan-33 fixture file that preserves photon direction, energy, merge, and scintillator-only promotion examples while the parent photon plan stays under the 500-line cap. |
| **plan-34 handoff companion** | Split plan-34 fixture file that preserves pi0 production, shadow, and validation handoff examples while the parent plan stays under the 500-line cap. |
...
l1_glossary_signoff:
  ...
  rows:
    ...
    - {term: plan-33 promotion companion, defence_package_refs: [em_cluster_truth_blindness], note_refs: [em_object_chain], audit_row_ref: l1_glossary_audit:plan-33 promotion companion, thesis_status: same | translated | flagged_delta, approved_by: <L1-owner-or-null>, caveat_text: <required when thesis_status is flagged_delta>}
