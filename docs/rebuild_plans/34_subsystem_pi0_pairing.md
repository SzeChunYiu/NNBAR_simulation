...
The detailed downstream handoff, promotion-check, evidence-bundle, and
reviewer-audit examples are split into
`docs/rebuild_plans/34_subsystem_pi0_pairing_handoff_examples.md` to keep
this plan below the line cap. The companion file is part of the P.5/P.6
contract and must be updated with any pairing, cut, timing-shadow, or
truth-label boundary change.
