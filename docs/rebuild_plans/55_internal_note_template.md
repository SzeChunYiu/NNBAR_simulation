...
|---|---|---|---|
| EM object chain | photon, pi0, or calorimeter result | P.1-P.7 method ids, Class-B drop hash status, closure row ids, plan-33 promotion companion id, plan-34 handoff companion id, selected DEC stubs | 31, 32, 33, 34, 35 |
...
The full YAML fixture is split into
`docs/rebuild_plans/55_internal_note_template_l1_annex_fixture.md` to keep
this plan below the line cap. The companion file owns the stable annex block
ids, review-evidence links, artifact-hash keys, and caveat fields consumed by
plans 50, 53, 54, and 56.
